                      ...
                      <tr>
                          ...
                          <td>
                              <div class="d-flex">
                                ...
                                <div class="col-auto me-1">
                                  <a href="{{ route('projects.edit', $project->id) }}" class="btn btn-primary"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pen" viewBox="0 0 16 16">
